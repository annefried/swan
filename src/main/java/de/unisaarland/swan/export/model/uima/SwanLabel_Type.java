...
public class SwanLabel_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unisaarland.swan.export.model.uima.SwanLabel");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("Name", "de.unisaarland.swan.export.model.uima.SwanLabel");
  ...
  public String getLabelSet(int addr) {
      ...
      jcas.throwFeatMissing("LabelSet", "de.unisaarland.swan.export.model.uima.SwanLabel");
