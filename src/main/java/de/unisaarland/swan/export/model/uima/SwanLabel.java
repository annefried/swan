  ...
  */  
  ...
  public String getName() {
    if (SwanLabel_Type.featOkTst && ((SwanLabel_Type)jcasType).casFeat_Name == null)
      jcasType.jcas.throwFeatMissing("Name", "de.unisaarland.swan.export.model.uima.SwanLabel");
  ...
  public String getLabelSet() {
    if (SwanLabel_Type.featOkTst && ((SwanLabel_Type)jcasType).casFeat_LabelSet == null)
      jcasType.jcas.throwFeatMissing("LabelSet", "de.unisaarland.swan.export.model.uima.SwanLabel");
