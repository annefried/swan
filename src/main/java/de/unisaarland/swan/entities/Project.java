...
public class Project extends BaseEntity {
	...
	/**
	 * Name query identifier for "search for projects and documents"
	 */
	public static final String QUERY_SEARCH_FOR_PROJECTS_AND_DOCUMENTS = "Project.QUERY_SEARCH_FOR_PROJECTS_AND_DOCUMENTS";
