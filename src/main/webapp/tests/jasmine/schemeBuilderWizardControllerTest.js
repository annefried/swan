...
describe('Test schemeBuilderWizardController', function () {
	...
	beforeEach(inject(function(_$controller_, _$injector_, _$q_, _$rootScope_, _$window_, _$http_, _$timeout_) {
		...
		controller = $controller('schemeBuilderWizardController', {
			$scope: $scope,
			$rootScope: $rootScope,
			$http: $http,
			$sce: $sce,
	...
	//TODO This was copied from the old schemeUploadMOdalControllerTest.js, needs to be adapted to schemeBuilderWizardController
	/**
	it('Test init', function() {
		expect($scope.step).toEqual(0);
		expect($scope.nextLabel).toEqual("Next");
