...
describe('Test annotationController', function () {
    ...
    describe('Setup tests', function () {
        ...
        it('Test readSchemes', function () {
            ...
            var linkLabelSet = controller.linkLabels["Situation"]["Situation"][2];
        ...
        it('Test getSpanType', function () {
            ...
            var span = controller.getSpanType("Situation");
        ...
        it('Test findWords', function () {
            controller.tokenData = testTokenData;
            controller.buildText();
            var anno = new Annotation(null, testAnnotationEntity.id, testAnnotationSpanType);
        ...
        it('Test buildAnnotations', function () {
            ...
            var anno = controller.annotationIdMap[testAnnotationEntity.id];
        ...
        it('Test buildLinks', function () {
            ...
            var link = controller.annotationLinks[testAnnotationEntity.id][testAnnotationEntity2.id];
        ...
        it('Test setSelectedLabel with Annotation', function () {
            ...
            var urlAdd = 'swan/annotations/addlabel/';
            var urlRemove = 'swan/annotations/removelabel/';
            $httpBackend
        ...
        it('Test setSelectedLabel with Link', function () {
            var $httpBackend = $injector.get('$httpBackend');
            var urlAdd = 'swan/links/addlabel/';
            var urlRemove = 'swan/links/removelabel/';
            $httpBackend
        ...
        it('Test updateAnno with existing identical annotation', function () {
            ...
            var duplicateAnno = new Annotation(null, 5, testAnnotationSpanType);
        ...
        it('Test nextWord', function () {
            var nextWord = controller.nextWord(5);
        ...
        it('Test increaseSelectedAnnoSizeRight', function () {
            var Anno = new Annotation(null, 5, testAnnotationSpanType);
        ...
        it('Test previousWord', function () {
            var prevWord = controller.previousWord(5);
        ...
        it('Test isSpanTypeAlreadyApplied', function () {
            ...
            var alreadyApplied = controller.isSpanTypeAlreadyApplied(duplicateAnno, testAnnotationSpanType);
        ...
        it('Test setSelectedSpanTypeAndAdd with new annotation', function () {
            var Anno = new Annotation(null, 5);
            Anno.addWord(testTextWord1);
            controller.selectedNode = Anno;
        ...
        it('Test Test setSelectedSpanTypeAndAdd with existing annotation', function () {
            ...
            spyOn(controller, 'removeConnectedLinks');
            var $httpBackend = $injector.get('$httpBackend');
            var url = 'swan/annotations/changest/' + controller.selectedNode.id;
            $httpBackend
        ...
        it('Test setSelectedSpanTypeAndAdd with duplicate annotation', function () {
            ...
            var duplicateAnno = new Annotation(null, 6);
            duplicateAnno.addWord(testTextWord1);
        ...
        it('Test setTemporaryAnnotation', function () {
            var Anno = new Annotation(null, 5);
            Anno.addWord(testTextWord1);
            var n = testTextWord1.annotatedBy;
            controller.tempAnno = Anno;
            controller.selectedNode = null;
            ...
            var newAnno = controller.selectedNode;
        ...
        it('Test removeAnnotation', function () {
            ...
            var $httpBackend = $injector.get('$httpBackend');
            var url = 'swan/annotations/' + Anno.id;
            $httpBackend
                .when('DELETE', url)
                .respond(200);
            $httpBackend
        ...
        it('Test linkable', function () {
            // Test linkable
            var linkable = controller.linkable(testAnnotation2, testAnnotation);
            expect(linkable).toEqual(true);
            // Test already existing
            var linkable = controller.linkable(testAnnotation, testAnnotation2);
            expect(linkable).toEqual(false);
            // Test not linkable
            var Anno = new Annotation(null, 5, testAnnotationSpanType2);
            var linkable = controller.linkable(testAnnotation, Anno);
            expect(linkable).toEqual(false);
        });
        //TODO test adddLink
        it('Test removeLink', function () {
            ...
            var $httpBackend = $injector.get('$httpBackend');
            var url = 'swan/links/' + testLinkAnnotation.id;
            $httpBackend
                .when('DELETE', url)
                .respond(200);
            $httpBackend
        ...
        it('Test removeConnectedLinks', function () {
            var anno1 = testAnnotation; // id 3
            var anno2 = testAnnotation2; // id 4
            var anno3 = new Annotation(null, 5, testAnnotationSpanType);
            var link1 = testLinkAnnotation; // anno1 to anno2
            var link2 = new AnnotationLink(2, anno2, anno1, { 2: testAnnotationLinkTypes[0] });
            var link3 = new AnnotationLink(3, anno2, anno3, { 2: testAnnotationLinkTypes[0] });
        ...
        it('Test getOnlySpanType', function () {
            var onlySpan = controller.getOnlySpanType();
        ...
        it('Test removeAnnotationFromDataStructure', function () {
            var newAnno = new Annotation(null, 5, testAnnotationSpanType);
        ...
        it('Test isPunctuation', function () {
            var isPunct = controller.isPunctuation(".");
        ...
        it('Test setAnnotationNotSure', function () {
            var anno = controller.annotationIdMap[testAnnotation.id];
            var $httpBackend = $injector.get('$httpBackend');
            var url = 'swan/annotations/notsure/' + anno.id;
