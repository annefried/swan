...
describe('Test rootController', function () {
    ...
    describe('Setup tests', function () {
        ...
        var $q, deferred;
        beforeEach(inject(function (_$controller_, $controller, _$injector_, _$q_, _$rootScope_, _$window_, _$http_, _$timeout_) {
        ...
        it('Test loadProjectsCount', function () {
            var $httpBackend = $injector.get('$httpBackend');
            var url = "swan/project/count/byuser/" + $window.sessionStorage.uId;
            var response = 2;
            $httpBackend
                .when('GET', url)
                .respond(200, response);
        ...
        it('Test buildDocuments with wrong assigned user', function () {
            ...
            var unknownUser = new User(5, "", "", "", "annotator");
            var states1 = [
        ...
        describe("Test buildTableProjects", function () {
            ...
            var users2 = [new User(3, "", "", "", "annotator")];
            // FIXME project underscore must be wrong
            // Leave this until we changed to enums, this should throw then an error
            var projectManager = [new User(77, "", "", "", "project_manager")];
            var watchingUsers = [new User(77, "", "", "", "project_manager")];
...
//# sourceMappingURL=rootControllerTest.js.map