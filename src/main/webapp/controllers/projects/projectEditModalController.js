...
angular
    ...
    .controller('projectEditModalController', function ($scope, $rootScope, $http, $uibModalInstance, $window) {
        ...
        $scope.addSelectedUser = function () {
            $http.post("swanold/project/add/" + $rootScope.currentProjectId + "/" + $scope.newUser).success(function (response) {
                var emptyTemplate = ['0'];
        ...
        $scope.addSelectedPM = function () {
            $http.post("swanold/project/addManager/" + $rootScope.currentProjectId + "/" + $scope.newPM).success(function (response) {
                var emptyTemplate = ['0'];
        ...
        $scope.deleteUser = function (uId) {
            $http.post("swanold/project/del/" + $rootScope.currentProjectId + "/" + uId).success(function (response) {
        ...
        $scope.deletePM = function (uId) {
            $http.post("swanold/project/delManager/" + $rootScope.currentProjectId + "/" + uId).success(function (response) {
        ...
        $scope.watchProject = function (bool) {
            ...
            if (bool) {
                ...
                $http.post("swanold/project/addWatchingUser/" + proj.id + "/" + $window.sessionStorage.uId).success(function (response) {
                ...
                $http.post("swanold/project/delWatchingUser/" + proj.id + "/" + $window.sessionStorage.uId).success(function (response) {
