    ...
    .directive('d3Timeline', ['d3', function(d3) {
        return {
            ...
            link: function($scope, iElement) {
                ...
                var HORIZONTAL_STR = "HORIZONTAL";
                var VERTICAL_STR = "VERTICAL";
                
                var BEFORE_INT = 0;
                var OVERLAP_INT = 1;
                var AFTER_INT = 2; // Supported but not used
                
                var NOT_LINKED = 0;
                
                var EDGE_ROUNDING = 4;
                var BOX_HEIGHT = 20;
                var BOX_HEIGHT_PADDING = BOX_HEIGHT + 25; // Distance between boxes in y dimension
                var BOX_WIDTH_PADDING = 30; // Distance between boxes in x dimension
